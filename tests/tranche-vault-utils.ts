...
import {
  ...
  YieldPayoutFailed,
  YieldReinvested
} from "../generated/TrancheVault/TrancheVault"
...
export function createRedemptionRequestAddedEvent(
  ...
  let redemptionRequestAddedEvent =
    changetype<RedemptionRequestAdded>(newMockEvent())
...
export function createRedemptionRequestRemovedEvent(
  ...
  let redemptionRequestRemovedEvent =
    changetype<RedemptionRequestRemoved>(newMockEvent())
...
export function createReinvestYieldConfigSetEvent(
  ...
  let reinvestYieldConfigSetEvent =
    changetype<ReinvestYieldConfigSet>(newMockEvent())
